...
class ProposalsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // {
            ...
            return view('admin.proposal.index', compact('proposals', 'customer', 'status'));
        // }
        // else
        // {
    ...
    public function customer(Request $request)
    {
        ...
        return view('admin.proposal.customer_detail', compact('customer'));
    }
...
//                $proposalProduct->discount    = isset($products[$i]['discount']) ? $products[$i]['discount'] : 0;
            ...
            \DB::commit();
            return redirect('admin/proposals/'.\Crypt::encrypt($proposal->id))->with('success', __('Proposal successfully created.'));
        }catch(\Throwable $e){
            return $e->getMessage();
    ...
    public function edit($id)
    {
        ...
        // {
            ...
            return view('admin.proposal.edit', compact('customers', 'product_services', 'proposal', 'proposal_number', 'category', 'customFields', 'items'));
        // }
        // else
        // {
        //     return redirect()->back()->with('error', __('Permission denied.'));
...
//                dd($proposalArr);
    ...
    public function invoiceLink($proposalID)
    {
        ...
        return view('admin.proposal.customer_proposal',compact('proposal','customer','iteams','customFields','status','user'));
    }
