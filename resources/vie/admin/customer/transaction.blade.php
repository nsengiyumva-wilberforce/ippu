                ...
                <div class="card-body table-border-style">
                    <div class="row d-flex justify-content-end mt-2">
                        ...
                        <div class="col-auto my-auto">
                            <a href="#" class="apply-btn" onclick="document.getElementById('frm_submit').submit(); return false;" data-toggle="tooltip" title="{{__('apply')}}">
                                <span class="btn-inner--icon"><i class="las la-search"></i></span>
                            </a>
                            <a href="{{route('customer.transaction')}}" class="reset-btn" data-toggle="tooltip" title="{{__('Reset')}}">
                                <span class="btn-inner--icon"><i class="las la-trash-restore-alt"></i></span>
                            </a>
