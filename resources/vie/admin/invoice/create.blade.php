...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'admin/invoices','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Form::select('customer_id', $customers,$customerId, array('class' => 'form-control select','id'=>'customer','data-url'=>url('admin/invoices/customer'),'required'=>'required')) }}
                        ...
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group ">
                                    {{ Form::select('item', $product_services,'', array('class' => 'form-control select2 item','data-url'=>url('admin/invoices/product'),'required'=>'required')) }}
                                </td>
                                <td>
