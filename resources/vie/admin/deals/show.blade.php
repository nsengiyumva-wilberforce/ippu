                                                ...
                                                <div class="w-100">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        @can('edit task')
                                                                ...
                                                                <a href="#" class="" data-title="{{__('Edit Task')}}" data-url="{{route('deals.tasks.edit',[$deal->id,$task->id])}}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Edit')}}"><i class="las la-edit text-white"></i></a>
                                                            </div>
                                                            @endcan
                                                            @can('delete task')
