                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            {{-- <p class="mt-3 fs-15 fw-medium">No 1. ERP</p> --}}
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            {{-- <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Orbit ERP. Crafted with <i class="mdi mdi-heart text-danger"></i> by Angus Technologies
                            </p> --}}
                        </div>
                    </div>
                </div>
