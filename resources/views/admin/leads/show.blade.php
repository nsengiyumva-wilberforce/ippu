...
@push('script-page')
    ...
    <script>
        ...
        myDropzone = new Dropzone("#dropzonewidget", {
            ...
            url: "{{url('leads.file.upload',$lead->id)}}",
        ...
        function dropzoneBtn(file, response) {
            ...
            del.innerHTML = "<i class='las la-trash'></i>";
        ...
        dropzoneBtn(mockFile, {download: "{{url('leads.file.download',[$lead->id,$file->id])}}", delete: "{{url('leads.file.delete',[$lead->id,$file->id])}}"});
        @endif
        @endforeach
        ...
        $('.summernote-simple').on('summernote.blur', function () {
            ...
            $.ajax({
                url: "{{url('leads.note.store',$lead->id)}}",
...
@section('action-btn')
    <div class="float-end">
        {{-- @can('convert lead to deal') --}}
            @if(!empty($deal))
                <a href="@can('View Deal') @if($deal->is_active) {{url('deals.show',$deal->id)}} @else # @endif @else # @endcan" data-size="lg" data-bs-toggle="tooltip" title=" {{__('Already Converted To Deal')}}" class="btn btn-sm btn-primary">
        ...
        <a href="#" data-size="lg" data-url="{{ url('leads.edit',$lead->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Edit')}}" class="btn btn-sm btn-primary">
...
<div class="text-end mb-3">
        {{-- @can('convert lead to deal') --}}
            ...
            @else
                <a href="#" data-size="lg" data-url="{{ URL::to('admin/leads/'.$lead->id.'/show_convert') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Convert ['.$lead->subject.'] To Deal')}}" class="btn btn-sm btn-primary">
                    <i class="las la-exchange-alt"></i>
                </a>
            @endif
        {{-- @endcan --}}
                                ...
                                <div class="col-md-4 col-sm-4 mt-4">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <h5 class="mb-0 text-warning">{{$lead->created_at}}</h5>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <h5>{{__('Users')}}</h5>
                                            <div class="float-end">
                                                <a data-size="md" data-url="{{ url('leads.users.edit',$lead->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add User')}}" class="btn btn-sm btn-primary ">
                                                        ...
                                                        @can('edit lead')
                                                            <td>
                                                                <div class="action-btn bg-danger ms-2">
                                                                    {!! Form::open(['method' => 'DELETE', 'url' => ['leads.users.destroy', $lead->id,$user->id],'id'=>'delete-form-'.$lead->id]) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h5>{{__('Products')}}</h5>
                                            <div class="float-end">
                                                <a data-size="md" data-url="{{ url('leads.products.edit',$lead->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add Product')}}" class="btn btn-sm btn-primary">
                                                    <i class="ri-add-fill"></i>
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                @foreach($lead->products() as $product)
                                                    <tr>
                                                        ...
                                                        @can('edit lead')
                                                            <td>
                                                                <div class="action-btn bg-danger ms-2">
                                                                    {!! Form::open(['method' => 'DELETE', 'url' => ['leads.products.destroy', $lead->id,$product->id]]) !!}
                                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}"><i class="las la-trash text-white"></i></a>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h5>{{__('Sources')}}</h5>
                                            <div class="float-end">
                                                <a data-size="md" data-url="{{ url('admin/leads/'.$lead->id.'/sources') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add Source')}}" class="btn btn-sm btn-primary">
                                                    <i class="ri-add-fill"></i>
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                @foreach($sources as $source)
                                                    <tr>
                                                        ...
                                                        @can('edit lead')
                                                            <td>
                                                                <div class="action-btn bg-danger ms-2">
                                                                    {!! Form::open(['method' => 'DELETE', 'url' => ['leads.sources.destroy', $lead->id,$source->id],'id'=>'delete-form-'.$lead->id]) !!}
                                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}"><i class="las la-trash text-white"></i></a>
                                    ...
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            @can('create lead email')
                                                <div class="float-end">
                                                    <a data-size="md" data-url="{{ url('leads.emails.create',$lead->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create Email')}}" class="btn btn-sm btn-primary">
                                                        <i class="ri-add-fill"></i>
                                                    </a>
                                                </div>
                                            @endcan
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h5>{{__('Discussion')}}</h5>
                                            <div class="float-end">
                                                <a data-size="lg" data-url="{{ url('leads.discussions.create',$lead->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add Message')}}" class="btn btn-sm btn-primary">
                                                    <i class="ri-add-fill"></i>
                                                </a>
                                            </div>
                    ...
                    <div id="calls" class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="float-end">
                                    <a data-size="lg" data-url="{{ url('leads.calls.create',$lead->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Add Call')}}" class="btn btn-sm btn-primary">
                                        <i class="ri-add-fill"></i>
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @can('delete lead call')
                                                    <div class="action-btn bg-danger ms-2">
                                                        {!! Form::open(['method' => 'DELETE', 'url' => ['leads.calls.destroy', $lead->id,$call->id],'id'=>'delete-form-'.$lead->id]) !!}
                                                        <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" title="{{__('Delete')}}"><i class="las la-trash text-white"></i></a>
