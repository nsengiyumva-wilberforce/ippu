		...
		<div class="row g-4">
			...
			<div class="col">
				<div class="p-2">
					...
					<p class="text-white-75">{{ $member?->account_type?->name }}</p>
					<div class="hstack text-white-50 gap-1">
						@if($member->address)
						<div class="me-2">
							<i class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>{{ $member->address }}
						</div>
						@endif
						<div>
							<i class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>{{ $member->organisation }}
						</div>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="d-flex profile-wrapper">
					...
					<div class="flex-shrink-0">
						...
						<a href="javascript:void(0);" class="btn btn-success" title="{{__('Update Member Details')}}" data-bs-toggle="tooltip" data-url="{{ url('admin/update_member_details/'.$member->id) }}" data-ajax-popup="true" data-size="md"><i class="ri-edit-box-line align-bottom"></i>Edit Member</a> 
						<a href="{{ url('membership_certificate') }}" class="btn btn-secondary"><i class="ri-download-2-fill"></i> Download Certificate</a>
						{{-- <a href="pages-profile-settings.html" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Download </a> --}}
					</div>
				</div>
				<!-- Tab panes -->
											...
											<table class="table table-borderless mb-0">
												<tbody>
													...
													<tr>
														...
														<td class="text-muted">{{ ($member->membership_number) ? $member->membership_number : '-'}}</td>
													</tr>
													<tr>
														<th class="ps-0" scope="row">Organisation :</th>
														<td class="text-muted">{{ ($member->organisation) ? $member->organisation : '-'}}</td>
													</tr>
													<tr>
														<th class="ps-0" scope="row">Contacts :</th>
														<td class="text-muted">{{ ($member->phone_no)?($member->phone_no .' '. ($member->alt_phone_no) ?:''):'-' }}
														</td>
													</tr>
													<tr>
														<th class="ps-0" scope="row">Joining Date</th>
														<td class="text-muted">{{ date('d M, y',strtotime($member->created_at)) }}</td>
													</tr>
												</tbody>
											</table>
										</div>
