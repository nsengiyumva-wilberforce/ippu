...
@section('content')
 <div class="text-end mb-3">
        ...
        {{--        </div>--}}
        <div class="col-auto">
            <a href="{{ url('admin/deals_list') }}" data-size="lg" data-bs-toggle="tooltip" title="{{__('List View')}}" class="btn btn-sm btn-primary">
                <i class="ri-list-check"></i>
            </a>
            {{-- @can('create deal') --}}
            <a href="#" data-size="lg" data-url="{{ url('admin/deals/create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create New Deal')}}" class="btn btn-sm btn-primary">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item d-inline-flex align-items-center" data-bs-toggle="tooltip" title="{{__('Tasks')}}">
                                                        <i class="f-16 text-primary ri-list-check"></i> {{count($deal->tasks)}}/{{count($deal->complete_tasks)}}
                                                    </li>
                                                </ul>
