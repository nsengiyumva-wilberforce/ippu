...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">{{ $event->name }} - Edit</li>
        </ol>
    </div>
...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('events.update', compact('event')) }}" method="POST" class="m-0 p-0" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="card-body row">
                    ...
                    <div class="mb-3 col-lg-6">
                        ...
                        <input type="datetime-local" name="end_date" id="end_date" class="form-control" value="{{@old('end_date', $event->end_date)}}" />
                    ...
                    <div class="mb-3 col-lg-4">
                        ...
                        <input type="text" name="rate" id="rate" class="form-control number_format" value="{{@old('rate', ($event->rate))}}" />
                        @if($errors->has('rate'))
                    ...
                    <div class="mb-3 col-lg-4">
                        ...
                        <input type="text" name="member_rate" id="member_rate" class="form-control number_format" value="{{@old('member_rate', ($event->member_rate))}}" />
                    ...
                    <div class="mb-3 col-lg-4">
                        ...
                        <input type="number" name="points" id="points" class="form-control" value="{{@old('points', ($event->points))}}" />
                    ...
                    <div class="mb-3 col-lg-6">
                        ...
                        <input type="file" name="attachment_name" id="attachment_name" class="form-control" value="{{@old('attachment_name', $event->attachment_name)}}" />
                    ...
                    <div class="mb-3 col-lg-6">
                        ...
                        <input type="file" name="banner_name" id="banner_name" class="form-control" value="{{@old('banner_name', $event->banner_name)}}" />
                    ...
                    <div class="mb-3 col-lg-12">
                        ...
                        <textarea class="ckeditor" name="details">{{ @old('details',$event->details) }}</textarea>
                ...
                <div class="card-footer">
                    <div class="d-flex flex-row align-items-center justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">@lang('Update Event')</button>
                    </div>
                </div>
            </form>
        </div>
