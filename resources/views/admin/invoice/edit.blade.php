...
@section('content')
    {{--    @dd($invoice)--}}
    <div class="row">
        {{ Form::model($invoice, array('url' => array('admin/invoices/'. $invoice->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Form::select('customer_id', $customers,null, array('class' => 'form-control select ','id'=>'customer','data-url'=>url('invoice.customer'),'required'=>'required')) }}
                            </div>
                        ...
                        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                            <div class="all-button-box me-2">
                                <a href="#" data-repeater-create="" class="btn btn-primary" data-bs-toggle="modal" data-target="#add-bank">
                                    <i class="ri-add-fill"></i> {{__('Add item')}}
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group">
                                    {{ Form::select('item', $product_services,null, array('class' => 'form-control item select','data-url'=>url('admin/invoices/product'))) }}
...
{{--                                        <a href="#" class="las la-trash text-white text-danger delete_item" data-repeater-delete></a>--}}
{{--                                    @endcan--}}

                                        <a href="#" class="las la-trash text-white repeater-action-btn bg-danger btn ms-2  delete_item" data-repeater-delete></a>
        ...
        <div class="modal-footer">
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{url("invoice.index")}}';" class="btn btn-light">
    ...
    <script>
        ...
        // $('.delete_item').click(function () {
            if (confirm('Are you sure you want to delete this element?')) {
                ...
                $.ajax({
                    url: '{{url('invoice.product.destroy')}}',
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': jQuery('#token').val()
                    },
