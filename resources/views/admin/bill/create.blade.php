...
@section('breadcrumb')
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
           ...
           <li class="breadcrumb-item"><a href="{{url('admin/bills')}}">{{__('Bills')}}</a></li>
...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'admin/bills','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="vender-box">
                                ...
                                {{ Form::select('vender_id', $venders,$vendorId, array('class' => 'form-control select select_vender','id'=>'vender','data-url'=>url('admin/bill/vender'),'required'=>'required')) }}
                            </div>
...
{{--                                </div>--}}
        ...
        <div class="modal-footer">
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{url("bills")}}';" class="btn btn-light">
