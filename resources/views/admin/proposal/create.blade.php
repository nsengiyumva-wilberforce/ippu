...
@section('breadcrumb')
   {{--  <li class="breadcrumb-item"><a href="{{url('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item"><a href="{{url('proposal.index')}}">{{__('Proposal')}}</a></li>
...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'admin/proposals','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Form::select('customer_id', $customers,$customerId, array('class' => 'form-control select','id'=>'customer','data-url'=>url('admin/proposals/customer'),'required'=>'required')) }}
                            </div>
...
{{--                                </div>--}}
        ...
        <div class="col-12">
                        ...
                        <table class="table mb-0" data-repeater-list="items">
                            ...
                            <tr>
                                <td width="25%" class="form-group">
                                    {{ Form::select('item', $product_services,'', array('class' => 'form-control item'  ,'data-url'=>url('admin/proposals/product'),'required'=>'required')) }}
                                </td>
                                <td>
            ...
            <div class="modal-footer">
                <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{url("proposal.index")}}';" class="btn btn-light">
