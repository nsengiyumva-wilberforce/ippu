...
<table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom"><tr><td>
  <img src="https://cdn.useblocks.io/19494/240108_1492_yXoek4c.jpg" width="188" border="0" alt="" style="display: block; width: 100%; max-width: 188px;">
</td></tr></table>
</td>
                                            </tr>
                                        </table>
                ...
                <tr>
                  <td width="720" valign="top" class="em-mob-wrap em-mob-width-100perc">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                      <tr>
                        <td>
                          <div class="em-font-Mulish-Regular" style="font-family: -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; line-height: 24px; color: #595959; font-size: 16px;" align="left"><br>Dear {{ $user->name }},<br>Your account status is now <strong><span style="font-size: 20px;">{{ $user->status }}</span></strong>.
                            @if($user->comment)
                            <br><br><strong>Comment</strong><br>{{ $user->comment }}.
                            @endif
                            <br><br>Thank you,<br>Best Regards,<br>IPPU Team.</div>
                        </td>
                      </tr>
                    </table>
                  </td>
