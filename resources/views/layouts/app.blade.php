...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/libs/datatables/1.11.5/css/dataTables.bootstrap5.min.css') }}" />
...
<script type='text/javascript' src='{{ asset('assets/libs/flatpickr/flatpickr.min.js') }}'/>
<!-- App js -->
...
<script src="{{ asset('assets/libs/datatables/1.11.5/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('assets/libs/datatables/1.11.5/js/dataTables.bootstrap5.min.js') }}"></script>
<script src="{{ asset('assets/libs/datatables/responsive/2.2.9/js/dataTables.responsive.min.js') }}"></script>
<script src="{{ asset('assets/libs/datatables/buttons/2.2.2/js/dataTables.buttons.min.js') }}"></script>
...
{{-- <script src="http://malsup.github.io/jquery.blockUI.js"> --}}
    <script type="text/javascript">
        ...
        @if (session('success'))
        toast("{{ session('success') }}","bg-success")
        @endif

        @if (session('warning'))
        toast("{{ session('warning') }}","bg-warning")
        @endif

        @if (session('error'))
        toast("{{ session('error') }}","bg-danger")
        @endif
