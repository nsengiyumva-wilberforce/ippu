    ...
    <script>
        ...
        function changeItem(element) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        url: '<?php echo e(url('admin/proposal/items')); ?>',
                        type: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': jQuery('#token').val()
                        },
        ...
        $(document).on('click', '[data-repeater-delete]', function () {
            ...
            if (confirm('Are you sure you want to delete this element?')) {
                ...
                $.ajax({
                    url: '<?php echo e(url('admin/proposal/product/destroy')); ?>',
                    type: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': jQuery('#token').val()
                    },
...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(url('admin/proposals')); ?>"><?php echo e(__('Quotations')); ?></a></li>
            <li class="breadcrumb-item"><?php echo e(__('Quotation Edit')); ?></li>
        </ol>
    </div>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::model($proposal, array('url' => array('admin/proposal', $proposal->id), 'method' => 'PUT','class'=>'w-100'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                    ...
                                    <?php echo e(Form::select('customer_id', $customers,null, array('class' => 'form-control select ','id'=>'customer','data-url'=>url('admin/proposal/customer'),'required'=>'required'))); ?>
                        ...
                        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                            <div class="all-button-box me-2">
                                <a href="#" data-repeater-create="" class="btn btn-primary" data-bs-toggle="modal" data-target="#add-bank">
                                    <i class="ri-add-fill"></i> <?php echo e(__('Add Item')); ?>
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-0">
                                    <?php echo e(Form::select('item', $product_services,null, array('class' => 'form-control select item','data-url'=>url('admin/proposals/product')))); ?>
                                ...
                                <td>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete proposal product')): ?>
                                        <a href="#" class="las la-trash text-white repeater-action-btn bg-danger ms-2" data-repeater-delete></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <tr>
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(url("admin/proposal")); ?>';" class="btn btn-light">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ippu/resources/views/admin/proposal/edit.blade.php ENDPATH**/ ?>