...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
           ...
           <li class="breadcrumb-item"><a href="<?php echo e(url('admin/bills')); ?>"><?php echo e(__('Bills')); ?></a></li>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(array('url' => 'admin/bills','class'=>'w-100'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="vender-box">
                                ...
                                <?php echo e(Form::select('vender_id', $venders,$vendorId, array('class' => 'form-control select select_vender','id'=>'vender','data-url'=>url('admin/bill/vender'),'required'=>'required'))); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="las la-trash text-white text-white repeater-action-btn bg-danger ms-2" data-repeater-delete></a>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(url("bills")); ?>';" class="btn btn-light">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ippu.org/resources/views/admin/bill/create.blade.php ENDPATH**/ ?>