        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <nav class="m-header-right">
                    ...
                    <a href="<?php echo e(url('dashboard')); ?>"><i class="fas fa-home"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/staging.ippu.org/resources/views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>