            ...
            t.prototype.init = function () {
                a('[data-plugin="dragula"]').each(function () {
                    ...
                    r ? dragula(n, {
                        ...
                        $.ajax({
                            url: '<?php echo e(url('deals_order')); ?>',
                            type: 'POST',
...
<?php $__env->startSection('content'); ?>
 <div class="text-end mb-3">
        ...
        <div class="col-auto">
            <a href="<?php echo e(url('admin/deals_list')); ?>" data-size="lg" data-bs-toggle="tooltip" title="<?php echo e(__('List View')); ?>" class="btn btn-sm btn-primary">
                <i class="ri-list-check"></i>
            </a>
            
            <a href="#" data-size="lg" data-url="<?php echo e(url('admin/deals/create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create New Deal')); ?>" class="btn btn-sm btn-primary">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item d-inline-flex align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Tasks')); ?>">
                                                        <i class="f-16 text-primary ri-list-check"></i> <?php echo e(count($deal->tasks)); ?>/<?php echo e(count($deal->complete_tasks)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ippu.org/resources/views/admin/deals/index.blade.php ENDPATH**/ ?>