...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <a href="#" data-size="md" data-url="<?php echo e(url('admin/form_builders/create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create New Form')); ?>" class="btn btn-sm btn-primary">
                                    ...
                                    <td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="action-btn bg-success ms-2">
                                                <a href="<?php echo e(url('generate_form_qr?form_id='.$form->id.'&url='.url('/form/'.$form->code))); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Generate the qr code')); ?>"><i class="las la-qrcode"></i></a>
                                            </div>
                                            ...
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center cp_link" data-link="<?php echo e(url('/form/'.$form->code)); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Click to copy link')); ?>"><i class="las la-copy text-white"></i></a>
                                            </div>

                                            
                                                <div class="action-btn bg-secondary ms-2">
                                                    <a href="<?php echo e(url('admin/form_builders/'.$form->id)); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Form field')); ?>"><i class="ri-grid-fill text-white"></i></a>
                                                </div>
                                                ...
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="<?php echo e(url('admin/form_builders/'.$form->id.'/edit')); ?>" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Form Builder Edit')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\david\Desktop\work\ippu\ippu\resources\views/admin/form_builder/index.blade.php ENDPATH**/ ?>