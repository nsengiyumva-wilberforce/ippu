	...
	<div class="">
		...
		<div class="card-body">
			<div class="text-end mt-2">
				...
				<a href="#"  data-url="<?php echo e(url('attend_cpd/'.$event->id)); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Attend CPD')); ?>" class="btn btn-primary">Attend</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\redesign\ippu_chat\resources\views/members/cpds/details.blade.php ENDPATH**/ ?>