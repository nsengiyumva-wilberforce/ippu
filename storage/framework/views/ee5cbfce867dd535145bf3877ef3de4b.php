<div class="container-fluid">
    ...
    <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('admin/reminders/?status=Unread')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('admin/calender')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('admin/transactions')); ?>">
...
<?php /**PATH /var/www/staging.ippu.org/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>