...
<div class="row">
	<div class="col-xl-4">
		<div class="card">
			...
			<div>
				<a href="javascript:void(0);" class="btn btn-danger" title="<?php echo e(__('Update Member Details')); ?>" data-bs-toggle="tooltip" data-url="<?php echo e(url('admin/update_member_details/'.$member->id)); ?>" data-ajax-popup="true" data-size="md">Update Member Details</a> 
			</div>
		</div>
	</div>
	<div class="col-xl-8">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/staging.ippu.org/resources/views/admin/members/show.blade.php ENDPATH**/ ?>