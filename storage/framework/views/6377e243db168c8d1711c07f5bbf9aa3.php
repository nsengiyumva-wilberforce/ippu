...
<div class="container-flid">
	...
	<div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
		<div class="row g-4">
			<div class="col-auto">
				<div class="avatar-lg">
					<img src="<?php echo e(asset('assets/images/users/avatar-1.jpg')); ?>" alt="user-img" class="img-thumbnail rounded-circle" />
				</div>
			</div>
			<!--end col-->
			<div class="col">
				<div class="p-2">
					<h3 class="text-white mb-1"><?php echo e($member->name); ?></h3>
					<p class="text-white-75"><?php echo e($member?->account_type?->name); ?></p>
					<div class="hstack text-white-50 gap-1">
						<?php if($member->address): ?>
						<div class="me-2">
							<i class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i><?php echo e($member->address); ?>

						</div>
						<?php endif; ?>
						<div>
							<i class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i><?php echo e($member->organisation); ?>
					...
					<ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link fs-14" data-bs-toggle="tab" href="#activities" role="tab">
								<i class="ri-list-unordered d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">CPDs</span>
							</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link fs-14" data-bs-toggle="tab" href="#documents" role="tab">
								<i class="ri-folder-4-line d-inline-block d-md-none"></i> <span class="d-none d-md-inline-block">Subscriptions</span>
							</a>
						</li>
					</ul>
					<div class="flex-shrink-0">
						
						<a href="javascript:void(0);" class="btn btn-success" title="<?php echo e(__('Update Member Details')); ?>" data-bs-toggle="tooltip" data-url="<?php echo e(url('admin/update_member_details/'.$member->id)); ?>" data-ajax-popup="true" data-size="md"><i class="ri-edit-box-line align-bottom"></i>Edit Member</a> 
						<a href="<?php echo e(url('membership_certificate')); ?>" class="btn btn-secondary"><i class="ri-download-2-fill"></i> Download Certificate</a>
											...
											<table class="table table-borderless mb-0">
												<tbody>
													<tr>
														...
														<td class="text-muted"><?php echo e($member->name); ?></td>
													</tr>
													<tr>
														<th class="ps-0" scope="row">Membership No. :</th>
														<td class="text-muted"><?php echo e(($member->membership_number) ? $member->membership_number : '-'); ?></td>
													</tr>
													<tr>
														<th class="ps-0" scope="row">Organisation :</th>
														<td class="text-muted"><?php echo e(($member->organisation) ? $member->organisation : '-'); ?></td>
													</tr>
													<tr>
														<th class="ps-0" scope="row">Contacts :</th>
														<td class="text-muted"><?php echo e(($member->phone_no)?($member->phone_no .' '. ($member->alt_phone_no) ?:''):'-'); ?>

														</td>
													</tr>
													<tr>
														<th class="ps-0" scope="row">Joining Date</th>
														<td class="text-muted"><?php echo e(date('d M, y',strtotime($member->created_at))); ?></td>
													</tr>
												</tbody>
											</table>
										</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ippu.org/resources/views/admin/members/new.blade.php ENDPATH**/ ?>