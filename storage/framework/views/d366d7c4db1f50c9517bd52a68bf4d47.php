...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(url('admin/proposals')); ?>"><?php echo e(__('Quotation')); ?></a></li>
            <li class="breadcrumb-item"><?php echo e(__('Quotation Details')); ?></li>
        </ol>
    </div>
                            ...
                            <div class="row timeline-wrapper">
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit proposal')): ?>
                                        <a href="<?php echo e(url('proposal.edit',\Crypt::encrypt($proposal->id))); ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>"><i class="las la-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                    <?php endif; ?>
                                </div>
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    <div class="timeline-icons"><span class="timeline-dots"></span>
                                    ...
                                    <?php if($proposal->status==0): ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('send proposal')): ?>
                                            <a href="<?php echo e(url('proposal.sent',$proposal->id)); ?>" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" title="<?php echo e(__('Mark Sent')); ?>"><i class="ti ti-send mr-2"></i><?php echo e(__('Send')); ?></a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </div>
                                <div class="col-md-6 col-lg-4 col-xl-4">
                                    ...
                                    <br>
                                    <div class="float-right mt-2 col-md-3 float-end ml-5" data-toggle="tooltip" title="<?php echo e(__('Click to change status')); ?>">
                                        <select class="form-control status_change select2" name="status" data-url="<?php echo e(url('proposal.status.change',$proposal->id)); ?>">
            ...
            <div class="row justify-content-between align-items-center mb-3">
                <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                    <div class="all-button-box mx-2">
                        <a href="<?php echo e(url('proposal.resent',$proposal->id)); ?>" class="btn btn-primary"><?php echo e(__('Resend Proposal')); ?></a>
                    </div>
                    <div class="all-button-box">
                        <a href="<?php echo e(url('proposal.pdf', Crypt::encrypt($proposal->id))); ?>" class="btn btn-primary" target="_blank"><?php echo e(__('Download')); ?></a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
                            ...
                            <div class="row">
                                ...
                                <?php endif; ?>
                                    ...
                                    <div class="col">
                                        ...
                                        <?php echo DNS2D::getBarcodeHTML( url('customer/proposal/'.\Illuminate\Support\Facades\Crypt::encrypt($proposal->id)), "QRCODE",2,2); ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table mb-0 ">
                                            ...
                                            <?php $__currentLoopData = $proposal->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$iteam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ippu.org/resources/views/admin/proposal/view.blade.php ENDPATH**/ ?>