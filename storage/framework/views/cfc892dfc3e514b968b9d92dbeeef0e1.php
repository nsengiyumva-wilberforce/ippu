	...
	<div class="card">
		...
		<div class="card-body">
			<h4 class="card-title mb-2">
				<a href="<?php echo e(url('event_details/'.$event->id)); ?>"><?php echo e($event->name); ?></a>
			</h4>
			<div class="card-text">
				<div>
					<div class="bg-light p-2"> 
						...
						<span class="text-danger font-weight-bold fw-medium"><?php echo e(($event->member_rate)); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/staging.ippu.org/resources/views/members/events/index.blade.php ENDPATH**/ ?>