...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="text-end mb-3">
            <a href="#" data-size="md" data-url="<?php echo e(url('admin/form_builder/'.$formBuilder->id.'/field')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create New Filed')); ?>" class="btn btn-sm btn-primary">
                <i class="ri-add-fill"></i>
            </a>
        </div>
        <div class="col-xl-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\david\Desktop\work\ippu\ippu\resources\views/admin/form_builder/show.blade.php ENDPATH**/ ?>