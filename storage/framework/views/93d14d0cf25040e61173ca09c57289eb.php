                ...
                <tr>
                  <td width="720" valign="top" class="em-mob-wrap em-mob-width-100perc">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                      <tr>
                        <td>
                          <div class="em-font-Mulish-Regular" style="font-family: -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; line-height: 24px; color: #595959; font-size: 16px;" align="left"><br>Dear <?php echo e($user->name); ?>,<br>Your account status is now <strong><span style="font-size: 20px;"><?php echo e($user->status); ?></span></strong>.
                            <?php if($user->comment): ?>
                            <br><br><strong>Comment</strong><br><?php echo e($user->comment); ?>.
                            <?php endif; ?>
...
</body></html><?php /**PATH /var/www/staging.ippu.org/resources/views/mails/account.blade.php ENDPATH**/ ?>