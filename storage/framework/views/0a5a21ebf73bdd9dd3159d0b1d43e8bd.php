...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    ...
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(url('admin/customers')); ?>"><?php echo e(__('Customers')); ?></a></li>
...
<div class="float-end">
    ...
    <a href="<?php echo e(url('invoice.create',$customer->id)); ?>" class="btn btn-sm btn-primary">
        <?php echo e(__('Create Invoice')); ?>

    </a>
    <?php endif; ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create proposal')): ?>
    <a href="<?php echo e(url('proposal.create',$customer->id)); ?>" class="btn btn-sm btn-primary">
    ...
    <a href="#" data-size="lg" data-url="<?php echo e(url('customer.edit',$customer['id'])); ?>" data-ajax-popup="true" title="<?php echo e(__('Edit Customer')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" class="btn btn-sm btn-primary">
    ...
    <?php echo Form::open(['method' => 'DELETE','class' => 'delete-form-btn', 'url' => ['customer.destroy', $customer['id']]]); ?>
                ...
                <div class="table-responsive">
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="Id">
                                    <a href="<?php echo e(url('proposal.show',\Crypt::encrypt($proposal->id))); ?>" class="btn btn-outline-primary"><?php echo e(Auth::user()->proposalNumberFormat($proposal->proposal_id)); ?>
                                ...
                                <td class="Action">
                                    <span>
                                      ...
                                      <div class="action-btn bg-warning ms-2">
                                        <?php echo Form::open(['method' => 'get', 'url' => ['proposal.convert', $proposal->id],'id'=>'proposal-form-'.$proposal->id]); ?>

                                        <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" title="<?php echo e(__('Convert to Invoice')); ?>" title="<?php echo e(__('Convert to Invoice')); ?>" data-confirm="You want to confirm convert to invoice. Press Yes to continue or Cancel to go back" data-confirm-yes="document.getElementById('proposal-form-<?php echo e($proposal->id); ?>').submit();">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('convert invoice')): ?>
                                    <div class="action-btn bg-warning ms-2">
                                        <a href="<?php echo e(url('invoice.show',\Crypt::encrypt($proposal->converted_invoice_id))); ?>"
                                         class="mx-3 btn btn-sm  align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Already convert to Invoice')); ?>" title="<?php echo e(__('Already convert to Invoice')); ?>" >
                                 ...
                                 <div class="action-btn bg-success ms-2">
                                    <?php echo Form::open(['method' => 'get', 'url' => ['proposal.duplicate', $proposal->id],'id'=>'duplicate-form-'.$proposal->id]); ?>


                                    <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para" data-bs-toggle="tooltip" title="<?php echo e(__('Duplicate')); ?>"  title="<?php echo e(__('Duplicate Proposal')); ?>" data-confirm="You want to confirm duplicate this invoice. Press Yes to continue or Cancel to go back" data-confirm-yes="document.getElementById('duplicate-form-<?php echo e($proposal->id); ?>').submit();">
                                ...
                                <div class="action-btn bg-info ms-2">
                                    <a href="<?php echo e(url('proposal.show',\Crypt::encrypt($proposal->id))); ?>" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Show')); ?>" title="<?php echo e(__('Detail')); ?>">
                                ...
                                <div class="action-btn bg-primary ms-2">
                                    <a href="<?php echo e(url('proposal.edit',\Crypt::encrypt($proposal->id))); ?>" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" title="<?php echo e(__('Edit')); ?>">
                ...
                <div class="table-responsive">
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="Id">
                                    <a href="<?php echo e(url('invoice.show',\Crypt::encrypt($invoice->id))); ?>" class="btn btn-outline-primary"><?php echo e(Auth::user()->invoiceNumberFormat($invoice->invoice_id)); ?>
                                ...
                                <td class="Action">
                                    <span>
                                        ...
                                        <div class="action-btn bg-success ms-2">
                                            <a href="#" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Duplicate')); ?>" title="<?php echo e(__('Duplicate Invoice')); ?>" data-confirm="You want to confirm this action. Press Yes to continue or Cancel to go back" data-confirm-yes="document.getElementById('duplicate-form-<?php echo e($invoice->id); ?>').submit();">
                                                <i class="las la-copy text-white text-white"></i>
                                                <?php echo Form::open(['method' => 'get', 'url' => ['invoice.duplicate', $invoice->id],'id'=>'duplicate-form-'.$invoice->id]); ?>
                                        ...
                                        <div class="action-btn bg-info ms-2">
                                            <a href="<?php echo e(url('invoice.show',\Crypt::encrypt($invoice->id))); ?>" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Show')); ?>" title="<?php echo e(__('Detail')); ?>">
                                                <i class="las la-eye text-white text-white"></i>
                                            </a>
                                        </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="action-btn bg-primary ms-2">
                                            <a href="<?php echo e(url('invoice.edit',\Crypt::encrypt($invoice->id))); ?>" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" title="<?php echo e(__('Edit')); ?>">
                                                <i class="las la-edit text-white"></i>
                                            </a>
                                        </div>
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ippu/resources/views/admin/customer/show.blade.php ENDPATH**/ ?>