...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(array('url' => 'admin/proposals','class'=>'w-100'))); ?>
        ...
        <div class="col-12">
                        ...
                        <table class="table mb-0" data-repeater-list="items">
                            ...
                            <tr>
                                <td width="25%" class="form-group">
                                    <?php echo e(Form::select('item', $product_services,'', array('class' => 'form-control item'  ,'data-url'=>url('admin/proposals/product'),'required'=>'required'))); ?>
                                ...
                                <td>
                                    <a href="#" class="las la-trash text-white text-danger" data-repeater-delete></a>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
            ...
            <div class="modal-footer">
                <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(url("proposal.index")); ?>';" class="btn btn-light">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ippu.org/resources/views/admin/proposal/create.blade.php ENDPATH**/ ?>