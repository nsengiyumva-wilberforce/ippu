...
<table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom"><tr><td>
  <img src="https://cdn.useblocks.io/19494/240105_1492_kTbO2dN.png" width="187" border="0" alt="" style="display: block; width: 100%; max-width: 187px;">
</td></tr></table>
</td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td width="752" valign="top" class="em-mob-wrap em-mob-width-100perc">
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                                            <tr>
                                                <td bgcolor="#E6F7FF" style="background-color: #e6f7ff; padding: 24px;">
                                                    <div class="em-font-Mulish-Regular" style="font-family: -apple-system, 'Segoe UI', 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 16px; line-height: 24px; color: #1890ff;" align="left">Dear <strong><?php echo e($name); ?>,</strong><br>Thank you for registering with us.&nbsp;<br>Your verification code is <?php echo e($code); ?>.<br>Please use the code to verify your email address.<br><br>Best Regards,&nbsp;<br>IPPU Team</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <td align="center" style="padding: 24px 40px; background-color: #ffffff;" class="em-mob-padding_left-20 em-mob-padding_right-20" bgcolor="#FFFFFF">
                            <table border="0" cellspacing="0" cellpadding="0" class="em-mob-width-100perc">
                                <tr>
                                    <td width="53" valign="top" class="em-mob-wrap em-mob-wrap-cancel em-mob-width-36px"></td>
                                    <td width="16" class="em-mob-wrap em-mob-wrap-cancel">&nbsp;</td>
                                    <td width="620" valign="top" class="em-mob-wrap em-mob-wrap-cancel em-mob-width-auto"></td>
                                </tr>
                            </table>
                        </td>
                    </tr><tr em="block" class="em-structure">
...
</body></html><?php /**PATH /var/www/ippu.org/resources/views/emails/verify-email.blade.php ENDPATH**/ ?>